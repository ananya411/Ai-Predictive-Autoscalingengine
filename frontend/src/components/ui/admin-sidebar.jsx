...
// import { useTheme } from "next-themes"; // Commenting out next-themes for now if not set up
...
export const AdminSidebar = memo(() => {
  ...
  return (
    <Sidebar collapsible="icon">
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link to="/dashboard">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">CloudSense</span>
      ...
      <SidebarFooter>
        <SidebarMenu>
          {/* Theme toggle removed for simplicity or until ThemeProvider is added */}
          {/* <SidebarMenuItem>
            <SidebarMenuButton
