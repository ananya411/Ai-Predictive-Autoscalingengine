...
import sampleDashbaord from "../../assets/img/lunexa-db.webp";
      ...
      <div className="relative z-10 container mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
        <motion.div
          ...
          <span className="mb-6 inline-block rounded-full border border-[#9b87f5]/30 px-3 py-1 text-xs text-[#9b87f5]">
            NEXT GENERATION OF CLOUD AUTOSCALING
          </span>
          <h1 className="mx-auto mb-6 max-w-4xl text-4xl font-light md:text-5xl lg:text-7xl">
            Scale Smarter with{" "}
            <span className="text-[#9b87f5]">AI-Powered</span> Cloud Insights
          </h1>
          <p className="mx-auto mb-10 max-w-2xl text-lg text-white/60 md:text-xl">
            Our AI-driven autoscaling engine analyzes real-time system metrics and
            predicts future load to automatically scale your infrastructure ensuring peak performance,
